...
public class ExecuteLeadTest {
		...
		public static void main(String[] args) throws Exception {
				...
				FileInputStream file = new FileInputStream(new File("/home/techl333t/eclipse-workspace/WMS/WMS_TC.xlsx"));
			   ...
			   if(data.get(i).equals("navigate"))
				...
				if(data.get(i).equals("chat"))
				{
					...
					System.out.println(objectName);
					System.out.println(objectType);
					keyword.chat(testdata, objectName, objectType);
				
				}
				
				if(data.get(i).equals("oneslider"))
				{
					...
					System.out.println(objectName);
					System.out.println(objectType);
					keyword.oneslider(objectName, objectType);
				...
				if(data.get(i).equals("mousehover"))
				{
					...
					System.out.println(objectName);
					System.out.println(objectType);
					keyword.mousehover(objectName, objectType);

				}
				
				if(data.get(i).equals("scanner"))
				{
					...
					System.out.println(objectName);
					System.out.println(objectType);
					keyword.scanner(objectName, objectType);
				
					
					
				}
				
				if(data.get(i).equals("HoverAndClick"))
				{
					...
					System.out.println(objectName);
					System.out.println(objectType);
					keyword.HoverAndClick(testdata, objectName, objectType);
